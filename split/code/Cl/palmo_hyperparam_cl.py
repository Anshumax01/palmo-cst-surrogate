...
OUTPUT_DIR  = r"C:\Users\anshu\Documents\Georgia Tech 26\Research\PALMO\Results Hyperparameterization\Cl"
...
def plot_arch_top(df, path):
    ...
    ax.bar(range(len(top)),top["r2"],color="steelblue",edgecolor="black",lw=0.5)
...
def plot_scatter(y_pred, y_test, path):
    ...
    ax.scatter(y_test,y_pred,s=1,alpha=0.2,color="steelblue")
...
def plot_error_distribution(y_pred, y_test, path):
    ...
    ax.hist(errors,bins=80,color="steelblue",edgecolor="none",alpha=0.85)
