"""
palmo_pytorch_nn_cm_400_4.py
============================
PALMO CST surrogate — Cm ONLY (PyTorch version)
Full 400x400x400x400 dedicated to moment coefficient.
Own manual scaling, own loss — no Cd/Cm contamination.
...
OUTPUT_DIR  = r"C:\Users\anshu\Documents\Georgia Tech 26\Research\PALMO\Results CST NN Split\Cm_PyTorch_400_4"
...
def main():
    ...
    plot_loss_summary(tr_loss,val_loss,y_pred,y_test,
                      path_curve=out("cm_training_curve.png"),path_summary=out("cm_loss_summary.png"))
